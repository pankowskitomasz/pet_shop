...
class HomeTop extends Component{
    render(){
        ...
        return(        
            <Container fluid className={"align-items-center py-3 d-flex minh-50vh"+this.props.classExt}>
                <Row className="mx-auto text-center w-100 py-5">
                    <Col xs={12} lg={7} className="mx-auto text-dark p-0 d-flex align-items-center text-end order-2 order-lg-1">
                        <img alt="about"
                            className="img-fluid mx-auto ms-md-start w-50"
                            src="img/home/home-img.png"/>
                    </Col>
                    <Col xs={8} lg={5} className="mx-auto p-0 d-flex align-items-center order-1 order-lg-2">
