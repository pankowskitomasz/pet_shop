...
class MessageTable extends Component {
    ...
    render() {
        ...
        return (
            <div>
                <Table striped bordered hover className="text-start w-100 border-dark-yellow">
                    <thead>
                        <tr className="text-dark-yellow border-dark-yellow">
                            <th>ID</th>
                            <th>Name</th>
                ...
                <div className="w-100 text-end">
                    <Button variant={"outline-light text-dark-yellow border-dark-yellow me-2"}
                        onClick={this.prevPage.bind(this)}>
                        &lt;
                    </Button>
                    <Button variant={"outline-light text-dark-yellow border-dark-yellow"}
